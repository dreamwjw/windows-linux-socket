...
BOOL CClientSocketDlg::OnInitDialog()
{
	...
	LONG lStyle;
	lStyle = GetWindowLong(m_lcStudent.m_hWnd, GWL_STYLE);//获取当前窗口style
	//lStyle &= ~LVS_TYPEMASK; //清除显示方式位
	lStyle |= LVS_REPORT; //设置表格style
	SetWindowLong(m_lcStudent.m_hWnd, GWL_STYLE, lStyle);//设置style
